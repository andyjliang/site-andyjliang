				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _Blog2.default }),
...
},{"./Blog":2,"./ProfileCard":3,"./Projects":4,"react":"react","react-router-dom":"react-router-dom"}],2:[function(require,module,exports){
'use strict';
...
var PostSummary = function (_Component) {
	...
	_createClass(PostSummary, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement('p', { className: 'tiny-text clickable', onClick: this.handleClick, dangerouslySetInnerHTML: { __html: this.props.text.substr(0, 200) + "...<b>Read More</b>" } })
			);
		}
	}]);
...
var Blog = function (_Component2) {
	...
	function Blog(props) {
		...
		var _this2 = _possibleConstructorReturn(this, (Blog.__proto__ || Object.getPrototypeOf(Blog)).call(this, props));
	...
	_createClass(Blog, [{
		...
		value: function render() {
			var postNodes = this.state.data.map(function (post) {
				return _react2.default.createElement(PostSummary, { key: post._id, text: post.text, date: post.date, title: post.title });
			});
			return _react2.default.createElement(
				'div',
				null,
...
},{"axios":6,"react":"react"}],3:[function(require,module,exports){
"use strict";
...
},{"./components/App":1,"history/createBrowserHistory":36,"react":"react","react-dom":"react-dom","react-router-dom":"react-router-dom"}],6:[function(require,module,exports){
...
},{"../core/createError":14,"./../core/settle":17,"./../helpers/btoa":21,"./../helpers/buildURL":22,"./../helpers/cookies":24,"./../helpers/isURLSameOrigin":26,"./../helpers/parseHeaders":28,"./../utils":30,"_process":40}],8:[function(require,module,exports){
'use strict';
...
},{"./adapters/http":7,"./adapters/xhr":7,"./helpers/normalizeHeaderName":27,"./utils":30,"_process":40}],20:[function(require,module,exports){
'use strict';
...
},{"./helpers/bind":20,"buffer":32}],31:[function(require,module,exports){
'use strict'
...
},{"base64-js":31,"ieee754":38}],33:[function(require,module,exports){
'use strict';
...
},{"./PathUtils":35,"resolve-pathname":41,"value-equal":42}],35:[function(require,module,exports){
'use strict';
...
},{"./DOMUtils":33,"./LocationUtils":34,"./PathUtils":35,"./createTransitionManager":37,"invariant":39,"warning":43}],37:[function(require,module,exports){
'use strict';
