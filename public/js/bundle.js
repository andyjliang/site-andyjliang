...
var _ProjectsContainer = require('../containers/ProjectsContainer');
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(_reactRouterDom.Route, { path: '/projects', component: _ProjectsContainer2.default }),
...
},{"../containers/BlogContainer":9,"../containers/PostContainer":10,"../containers/ProfileCardContainer":11,"../containers/ProjectsContainer":12,"../containers/ResumeContainer":13,"react":"react","react-rotating-text":83,"react-router-dom":"react-router-dom"}],3:[function(require,module,exports){
'use strict';
...
var PostIt = function (_Component) {
  ...
  _createClass(PostIt, [{
    ...
    value: function render() {
      ...
      var randomAngle = Math.floor(Math.random() * -25);
      var randomLeftShift = Math.floor(Math.random() * 550 - 50);
      var randomTopShift = Math.floor(Math.random() * 600 - 50);

      return _react2.default.createElement(
        'div',
        { key: this.props.index, style: { transform: "rotate(" + randomAngle + "deg)" } },
        _react2.default.createElement(
          _reactDraggable2.default,
          { defaultPosition: { x: randomLeftShift, y: randomTopShift }, bounds: { left: -20, top: -20, right: 450, bottom: 550 } },
          _react2.default.createElement(
            'div',
            { className: 'postit' },
            _react2.default.createElement(
...
var BulletinBoard = function (_Component2) {
  _inherits(BulletinBoard, _Component2);
  ...
  _createClass(BulletinBoard, [{
    ...
    value: function render() {
      ...
      var postItNodes = postIts.map(function (postIt, index) {
        return _react2.default.createElement(PostIt, { key: index, text: postIt.text });
      });

      return _react2.default.createElement(
        'div',
        { className: 'col-lg-8 bulletin-board' },
        postItNodes
      );
    }
  }]);
...
},{"react":"react","react-draggable":57}],5:[function(require,module,exports){
'use strict';
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'span',
						{ className: 'content-header' },
						'Projects Bulletin: Todo Ideas'
					)
				),
				_react2.default.createElement(_BulletinBoard2.default, null),
				_react2.default.createElement(
					'div',
					{ className: 'col-lg-8' },
					_react2.default.createElement(
						'h2',
						null,
						_react2.default.createElement('span', { className: 'glyphicon glyphicon-hourglass' }),
						'Coming soon ... '
					),
					_react2.default.createElement(
						'p',
						null,
						'Listing my ongoing and finished projects'
					)
				)
			);
		}
...
},{"./BulletinBoard":4,"react":"react"}],8:[function(require,module,exports){
"use strict";
		...
		value: function render() {
			...
			var work = {
				...
				entries: [{
					...
					entryProjects: [{
						...
						projectBullets: ["Central-to-product designer: move to stateless, as application scale in end-user numbers", "One-time RESTful calls to Oracle Essbase database, by using KnockoutJS data-binds to DOMs", "Imposed strict prototypical inheritance, with one-way data flow on MVC", "Giving definitive advantage over financial planning competitors on performance & UX"]
					}, {
						projectTitle: "Grid Interface",
						projectTime: "Nov 2014 – present",
						projectBullets: ["Developed grid feature used among 4 groups: Strategic Finance, Modeller, Smartform, & Planning", "Published model data structures with data-on-DOM to reflect MVC, as grid rerenders often", "Employed functionalized programming, and TDD lifecycle using QUnit for ease-of-testing", "Published APIs,  authored documentation & FAQs, guiding developers through use & debugging"]
					}, {
						projectTitle: "Jetified Templates ",
						projectTime: "Jan 2015 – Aug 2016",
						projectBullets: ["Built reusable layout templates in Oracle JET for quick starts & UI components to customize", "Optimized critical rendering path by resource preloading using RequireJS & network profiling"]
					}]
				}]
			};
			...
			var thisWebsite = {
				...
				entries: [{
					...
					entryTime: "",
					entrySubHeader: "",
					entryBullets: ["Full stack web app featuring served blog & interactive resume using RESTful API calls", "Implemented with MERN stack, following React + Redux data-flow design pattern", "Hosted on Heroku, database backed on mLab MongoDB, deployed using ExpressJS", "Optimized with React-Router, NPM axios for promise handling, automated with Gulp"]
				}]
			};
			...
			var volunteer = {
				...
				entries: [{
					...
					entryBullets: ["Web app using public city data of murals around Los Angeles for users to ‘adopt’ the art", "Wrote CRUD/serializations endpoints using routes to serve back page templates using Flask", "Used ORM SQLAlchemy to map schemas & process queries back to MySQL database", "Worked with UX team to draw the backend schemas, determine wireframes, & dictate tech-stack"]
				}]
			};
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(ResumeSection, thisWebsite),
...
},{"../actions/BlogActions":1,"../components/Blog":3,"react-redux":67}],10:[function(require,module,exports){
'use strict';
...
},{"../components/Post":5,"react-redux":67}],11:[function(require,module,exports){
'use strict';
...
},{"../actions/BlogActions":1,"../components/ProfileCard":6,"react-redux":67,"react-router-dom":"react-router-dom"}],12:[function(require,module,exports){
'use strict';
...
var ProjectsContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Projects2.default);

exports.default = ProjectsContainer;

},{"../components/Projects":7,"react-redux":67}],13:[function(require,module,exports){
'use strict';
...
},{"../components/Resume":8,"react-redux":67}],14:[function(require,module,exports){
'use strict';
...
},{"./components/App":2,"./reducers":107,"axios":15,"history/createBrowserHistory":46,"react":"react","react-dom":"react-dom","react-redux":67,"react-router-dom":"react-router-dom","redux":89}],15:[function(require,module,exports){
...
},{"../core/createError":23,"./../core/settle":26,"./../helpers/btoa":30,"./../helpers/buildURL":31,"./../helpers/cookies":33,"./../helpers/isURLSameOrigin":35,"./../helpers/parseHeaders":37,"./../utils":39,"_process":51}],17:[function(require,module,exports){
'use strict';
...
},{"./adapters/http":16,"./adapters/xhr":16,"./helpers/normalizeHeaderName":36,"./utils":39,"_process":51}],29:[function(require,module,exports){
'use strict';
...
},{"./helpers/bind":29,"is-buffer":50}],40:[function(require,module,exports){
"use strict";
...
},{"./emptyFunction":40,"_process":51}],43:[function(require,module,exports){
'use strict';
...
},{"./PathUtils":45,"resolve-pathname":101,"value-equal":105}],45:[function(require,module,exports){
'use strict';
...
},{"./DOMUtils":43,"./LocationUtils":44,"./PathUtils":45,"./createTransitionManager":47,"invariant":49,"warning":106}],47:[function(require,module,exports){
'use strict';
...
},{"warning":106}],48:[function(require,module,exports){
/**
...
},{"./lib/ReactPropTypesSecret":56,"_process":51,"fbjs/lib/invariant":41,"fbjs/lib/warning":42}],53:[function(require,module,exports){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./lib/ReactPropTypesSecret":56,"fbjs/lib/emptyFunction":40,"fbjs/lib/invariant":41}],54:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"./checkPropTypes":52,"./lib/ReactPropTypesSecret":56,"_process":51,"fbjs/lib/emptyFunction":40,"fbjs/lib/invariant":41,"fbjs/lib/warning":42}],55:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-present, Facebook, Inc.
 * All rights reserved.
...
},{"react":"react","react-dom":"react-dom"}],58:[function(require,module,exports){
(function (process){
'use strict';
...
},{"../utils/PropTypes":68,"../utils/warning":72,"_process":51,"prop-types":55,"react":"react"}],59:[function(require,module,exports){
(function (process){
'use strict';
...
},{"../utils/PropTypes":68,"../utils/Subscription":69,"_process":51,"hoist-non-react-statics":48,"invariant":49,"react":"react"}],60:[function(require,module,exports){
'use strict';
...
},{"../components/connectAdvanced":59,"../utils/shallowEqual":70,"./mapDispatchToProps":61,"./mapStateToProps":62,"./mergeProps":63,"./selectorFactory":64}],61:[function(require,module,exports){
'use strict';
...
},{"./wrapMapToProps":66,"redux":89}],62:[function(require,module,exports){
'use strict';
...
},{"../utils/verifyPlainObject":71,"_process":51}],64:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./verifySubselectors":65,"_process":51}],65:[function(require,module,exports){
'use strict';
...
},{"../utils/warning":72}],66:[function(require,module,exports){
(function (process){
'use strict';
...
},{"../utils/verifyPlainObject":71,"_process":51}],67:[function(require,module,exports){
'use strict';
...
},{"./components/Provider":58,"./components/connectAdvanced":59,"./connect/connect":60}],68:[function(require,module,exports){
'use strict';
...
},{"prop-types":55}],69:[function(require,module,exports){
"use strict";
...
},{"./warning":72,"lodash/isPlainObject":82}],72:[function(require,module,exports){
'use strict';
...
},{"./createStore":88,"./utils/warning":90,"_process":51,"lodash/isPlainObject":100}],87:[function(require,module,exports){
"use strict";
...
},{"lodash/isPlainObject":100,"symbol-observable":102}],89:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./applyMiddleware":84,"./bindActionCreators":85,"./combineReducers":86,"./compose":87,"./createStore":88,"./utils/warning":90,"_process":51}],90:[function(require,module,exports){
'use strict';
...
},{"./_root":98,"dup":73}],92:[function(require,module,exports){
arguments[4][74][0].apply(exports,arguments)
},{"./_Symbol":91,"./_getRawTag":95,"./_objectToString":96,"dup":74}],93:[function(require,module,exports){
arguments[4][75][0].apply(exports,arguments)
},{"dup":75}],94:[function(require,module,exports){
arguments[4][76][0].apply(exports,arguments)
},{"./_overArg":97,"dup":76}],95:[function(require,module,exports){
arguments[4][77][0].apply(exports,arguments)
},{"./_Symbol":91,"dup":77}],96:[function(require,module,exports){
arguments[4][78][0].apply(exports,arguments)
},{"dup":78}],97:[function(require,module,exports){
arguments[4][79][0].apply(exports,arguments)
},{"dup":79}],98:[function(require,module,exports){
arguments[4][80][0].apply(exports,arguments)
},{"./_freeGlobal":93,"dup":80}],99:[function(require,module,exports){
arguments[4][81][0].apply(exports,arguments)
},{"dup":81}],100:[function(require,module,exports){
arguments[4][82][0].apply(exports,arguments)
},{"./_baseGetTag":92,"./_getPrototype":94,"./isObjectLike":99,"dup":82}],101:[function(require,module,exports){
'use strict';
...
},{"./lib/index":103}],103:[function(require,module,exports){
(function (global){
'use strict';
